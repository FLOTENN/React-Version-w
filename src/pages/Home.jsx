                    ...
                    <div className="trust-wrapper">
                        ...
                        <div className="trust-content-box">
                            ...
                            <div style={{ marginTop: '40px' }}>
                                <AnimatedButton to="/about" className="" iconClass="fa-solid fa-arrow-right">DISCOVER MORE</AnimatedButton>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div className="container">
                        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-end', marginBottom: '50px' }}>
                            ...
                            <div className="hide-mobile">
                                <AnimatedButton href="https://g.page/r/CbGjCj_xXlVxEBM/review" target="_blank" rel="noreferrer" className="" iconClass="fa-solid fa-star">
                                    Leave a Feedback
                                </AnimatedButton>
                            </div>
                        </div>
                        ...
                        <div className="show-mobile" style={{ textAlign: 'center', marginTop: '40px', display: 'none' }}>
                            <AnimatedButton href="https://g.page/r/CbGjCj_xXlVxEBM/review" target="_blank" rel="noreferrer" className="" style={{ width: '100%' }} iconClass="fa-solid fa-star">
                                Leave a Feedback
                            </AnimatedButton>
                        </div>
                    </div>
